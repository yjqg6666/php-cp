...
inline static void msgpack_serialize_string(
    instead_smart *buf, char *str, size_t len)
...
inline static void msgpack_serialize_class(
    instead_smart *buf, zval *val, zval *retval_ptr, HashTable *var_hash,
...
inline static void msgpack_serialize_array(
    instead_smart *buf, zval *val, HashTable *var_hash, zend_bool object,
...
inline static void msgpack_serialize_object(
    instead_smart *buf, zval *val, HashTable *var_hash,
...
void msgpack_serialize_zval(
    instead_smart *buf, zval *val, HashTable *var_hash TSRMLS_DC)
